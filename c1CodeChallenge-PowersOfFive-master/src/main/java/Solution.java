...
public class Solution {
    ...
    final String[] input = {"101", "101101101", "1111101", "00000", "11111111111111111111111111111111111111111111111111",
    ...
    Iterator<String> knownPowersIterator;

    public Solution() {
        this.knownPowers = new LinkedList<>();
        knownPowers.addAll(Arrays.asList(knownPowersArray)); //use a Set for O(1) access;
        knownPowersIterator = knownPowers.iterator();
    }
