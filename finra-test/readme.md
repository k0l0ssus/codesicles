...
4. Flexible Design:
   ...
   to the common RoutingTransformer. This component then helps to set the request type, which will be used by the front-end router to dispatch the payload further to the intended camel routes. Combined with the flexibility of @XmlAnyElement, we are able to 
